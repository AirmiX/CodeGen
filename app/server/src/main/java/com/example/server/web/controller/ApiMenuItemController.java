...
import com.example.server.support.MenuItemDTOToMenuItem;
import com.example.server.support.MenuItemToMenuItemDTO;
...
public class ApiMenuItemController {
	...
	@RequestMapping(value = "/filterByRestaurant/{id}", method = RequestMethod.GET)
		ResponseEntity<List<MenuItemDTO>> getMenuItemListByRestaurant(@PathVariable Long id) {

		List<MenuItem> menuItemList;
		
		menuItemList = menuItemService.findByRestaurantId(id);
