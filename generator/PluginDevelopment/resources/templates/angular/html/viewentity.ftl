...
<div class="row">
	...
	<div class="col-md-4">
		<ul ng-repeat="${property.type?uncap_first} in ${property.type?uncap_first}List" class="list-group">
			<li class="list-group-item"><a href="/#/${property.type?uncap_first}List/{{ ${property.type?uncap_first}.id }}">{{${property.type?uncap_first}.${property.nextPresPropertyName}}}</a></li>
		</ul>
	</div>
</div>
