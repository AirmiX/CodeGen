...
class GenerateAction extends MDAction{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		String rootDirectory = "com.example.server";
		...
		try {
			...
			GeneratorOptions go17 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("AngularModuleGenerator");			
			AngularGenerator angularModuleGenerator = new AngularGenerator(go17);
			angularModuleGenerator.generateJSFile();
			
			GeneratorOptions go18 = ProjectOptions.getProjectOptions().getGeneratorOptions().get("AngularAppModuleGenerator");			
			AngularGenerator angularAppModuleGenerator = new AngularGenerator(go18);
			angularAppModuleGenerator.generateAppModuleJSFile();
