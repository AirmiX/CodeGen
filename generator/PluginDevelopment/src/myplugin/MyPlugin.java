...
public class MyPlugin extends com.nomagic.magicdraw.plugins.Plugin {
	...
	public void init() {
		...
		// Spring Model
		GeneratorOptions springModelOptions = new GeneratorOptions(output_path, "modelclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//model"); 				
		...
		// Spring Repository
		GeneratorOptions springRepositoryOptions = new GeneratorOptions(output_path, "repositoryclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//repository"); 				
		...
		// Spring Service
		GeneratorOptions springServiceOptions = new GeneratorOptions(output_path, "serviceclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//service"); 				
		...
		GeneratorOptions springServiceImplOptions = new GeneratorOptions(output_path, "serviceimplclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//service//impl"); 				
		...
		// Spring dto
		GeneratorOptions springDTOOptions = new GeneratorOptions(output_path, "dtoclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//web//dto"); 				
		...
		// Spring controller
		GeneratorOptions springControllerOptions = new GeneratorOptions(output_path, "controllerclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//web//controller"); 				
		...
		GeneratorOptions springModelToDTOOptions = new GeneratorOptions(output_path, "modeltodtoclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//support"); 				
		...
		GeneratorOptions springDTOtoModelOptions = new GeneratorOptions(output_path, "dtotomodelclass", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server//support"); 				
		...
		GeneratorOptions springApplicationFileOptions = new GeneratorOptions(output_path, "application", "templates//spring", "{0}.java", true, "server//src//main//java//com//example//server"); 				
		...
		// entity list
		GeneratorOptions angularEntityListPageOptions = new GeneratorOptions(output_path, "entitylist", "templates//angular//html", "{0}.html", true, "client//app//components"); 				
		...
		// add edit entity
		GeneratorOptions angularAddEditEntityPageOptions = new GeneratorOptions(output_path, "addeditentity", "templates//angular//html", "{0}.html", true, "client//app//components"); 				
		...
		// view list
		GeneratorOptions angularViewEntityPageOptions = new GeneratorOptions(output_path, "viewentity", "templates//angular//html", "{0}.html", true, "client//app//components"); 				
		...
		// index
		GeneratorOptions angularIndexPageOptions = new GeneratorOptions(output_path, "index", "templates//angular//html", "{0}.html", true, "client"); 				
		...
		// angular routes
		GeneratorOptions angularRoutesOptions = new GeneratorOptions(output_path, "angularroutes", "templates//angular", "{0}.js", true, "client//app//components"); 				
		...
		// angular services
		GeneratorOptions angularServicesOptions = new GeneratorOptions(output_path, "angularservices", "templates//angular", "{0}.js", true, "client//app//components"); 				
		...
		// angular controllers
		GeneratorOptions angularControllersOptions = new GeneratorOptions(output_path, "angularcontrollers", "templates//angular", "{0}.js", true, "client//app//components"); 				
		...
		// angular controllers
		GeneratorOptions angularModuleOptions = new GeneratorOptions(output_path, "angularmodule", "templates//angular", "{0}.js", true, "client//app//components"); 				
		angularModuleOptions.setTemplateDir(pluginDir + File.separator + angularModuleOptions.getTemplateDir()); //apsolutna putanja
		ProjectOptions.getProjectOptions().getGeneratorOptions().put("AngularModuleGenerator", angularModuleOptions);
		
		// angular controllers
		GeneratorOptions angularAppModuleOptions = new GeneratorOptions(output_path, "angularappmodule", "templates//angular", "{0}.js", true, "client//app"); 				
		angularAppModuleOptions.setTemplateDir(pluginDir + File.separator + angularAppModuleOptions.getTemplateDir()); //apsolutna putanja
		ProjectOptions.getProjectOptions().getGeneratorOptions().put("AngularAppModuleGenerator", angularAppModuleOptions);
